...
<footer id="page-footer" style="margin: 0px 0px;">
    
<div class="container blockplace1">
    <div class="row">
        <div class="left-col col-md-3">
            <span>&nbsp;</span>
            <p><a href="https://www.esocietybd.com">
                <img src="https://www.esocietybd.com/pluginfile.php/1/theme_adaptable/adaptablemarketingimages/0/logo2.png" alt="" class="img-responsive atto_image_button_text-bottom" width="198" height="60">
               </a>
            </p>
...
<div class="left-col col-md-3">
    ...
    <p><a style="font-size:15px;" href="https://www.esocietybd.com/local/staticpage/view.php?page=about_us">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; About Us</a></p>

    <p><a style="font-size:15px;" href="https://www.esocietybd.com/local/staticpage/view.php?page=our_advisers">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Our Advisers</a></p>

    <p><a style="font-size:15px;" href="https://www.esocietybd.com/local/staticpage/view.php?page=our_team">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Our Team</a></p>

    <p><a style="font-size:15px;" href="https://www.esocietybd.com/local/staticpage/view.php?page=our_mentors">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Our Mentors</a></p>

    <p><a style="font-size:15px;" href="https://www.esocietybd.com/local/staticpage/view.php?page=contact">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Contact Us</a></p>
...
<div class="left-col col-md-3">
    ...
    <p>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a style="font-size:18px;" href="https://www.facebook.com/Esociety-BD-2197644420503723/" target="_blank" class="fa fa-facebook" rel="noreferrer noopener">&nbsp;&nbsp; Facebook</a>
    </p>
    <p>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a style="font-size:18px;" href="https://twitter.com/esocietybd/" target="_blank" class="fa fa-twitter" rel="noreferrer noopener">&nbsp; Twitter</a>
    </p>
    <p>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a style="font-size:18px;" href="https://www.youtube.com/channel/UCL8gJqhmKhOkaTx1TXnKwOA" target="_blank" class="fa fa-youtube" rel="noreferrer noopener">&nbsp; Youtube</a>
    </p>
    <p>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a style="font-size:18px;" href="#" class="fa fa-pinterest">&nbsp; Pinterest</a>
    </p>
    <span>&nbsp;</span>
</div>
...
<div class="left-col col-md-3">
    ...
    <p>
        &nbsp;&nbsp;&nbsp;&nbsp; 
        <a style="font-size:16px;" class="fa fa-phone">&nbsp;Phone: +8801715733526
        </a>
    </p>
    <p>
        &nbsp;&nbsp;&nbsp;&nbsp; 
        <a style="font-size:16px;" class="fa fa-envelope">  Email: esocietybd@gmail.com</a>
    </p>
    <!--<p>
        &nbsp;&nbsp;&nbsp;&nbsp; 
        <a style="font-size:15px;">  <b>Address: </b>Level - 13, UTC Building,</a>
    </p>
    <p>
        &nbsp;&nbsp;&nbsp;&nbsp; 
        <a style="font-size:15px;">  8 Panthapath, Dhaka - 1215</a>
    </p>-->
    <span>&nbsp;</span>
</div>
</div>
...
if ($PAGE->theme->settings->moodledocs) {
    $footnoteclass = 'col-md-12 my-md-0 my-2';
} else {
    $footnoteclass = 'col-md-12 my-md-0 my-2';
}
